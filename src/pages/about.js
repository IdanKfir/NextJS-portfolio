...
const about = () => {
  return (
    <>
      <Head>
        <title>IdanKfir | About Page</title>
        <meta
          name='description'
          ...
          <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
            <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
              ...
              <p className='font-medium'>
                Hi, I am Idan Kfir, a Fullstack developer with Frontend
                expertise and a passion for creating beautiful, functional,
                user-centered digital experiences. With 1 year of experience in
                the field. I am always looking for new and innovative ways to
                bring my website visions to life.
              </p>
